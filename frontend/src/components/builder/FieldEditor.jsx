        ...
        <div className="space-y-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                <div className="space-y-6">
                    <div>
                        <label className="block text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2 font-mono ml-1">Field Label</label>
                        <input
                            type="text"
                ...
                <div className="space-y-6">
                    <h4 className="text-[10px] font-black text-primary-500/50 uppercase tracking-[0.2em] font-mono">Field Options</h4>

                    <div>
                        <label className="block text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2 font-mono ml-1">Placeholder Text</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2 font-mono ml-1">Help Text</label>
                        <input
                            type="text"
                    ...
                    {(field.type === 'dropdown' || field.type === 'checkbox') && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                            <label className="block text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2 font-mono ml-1">Choices (Options)</label>
                            <textarea
                            ...
                            ></textarea>
                            <span className="text-[8px] text-slate-700 font-mono mt-2 block uppercase tracking-tighter italic">// Enter each option on a new line</span>
                        </div>
                    )}
                    ...
                    {field.type === 'number' && (
                        <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
                            <div>
                                <label className="block text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2 font-mono ml-1">Min Value</label>
                                <input
                                    type="number"
                                    {...register('config.min')}
                                    className="input-field !py-3.5 !text-xs font-mono font-bold !bg-slate-900/30"
                            ...
                            <div>
                                <label className="block text-[9px] font-black text-slate-600 uppercase tracking-widest mb-2 font-mono ml-1">Max Value</label>
                                <input
                                    type="number"
                                    {...register('config.max')}
                                    className="input-field !py-3.5 !text-xs font-mono font-bold !bg-slate-900/30"
                ...
                <div className="pt-4">
                    ...
                    <p className="text-[8px] text-slate-800 font-mono text-center mt-4 tracking-widest uppercase">System Status: Active</p>
                </div>
            </form>
        </div>
    );
