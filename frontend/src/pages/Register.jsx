...
const Register = () => {
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            {/* Background elements */}
            <div className="absolute top-0 left-0 w-96 h-96 bg-primary-500/10 rounded-full filter blur-[120px] opacity-30"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-primary-500/5 rounded-full filter blur-[120px] opacity-30"></div>
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
                ...
                <h1 className="text-center text-5xl font-black tracking-tighter text-white mb-4 font-display">
                    Join eForm<span className="text-primary-500 italic">X</span>
                </h1>
