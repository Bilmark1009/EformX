...
const Register = () => {
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-0 left-0 w-96 h-96 bg-primary-100/50 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent-pink/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float" style={{ animationDelay: '3s' }}></div>
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
                ...
                <p className="text-center text-slate-500 font-medium tracking-tight mb-10 max-w-xs mx-auto">
                    Start creating premium data experiences today.
                </p>
            </div>
